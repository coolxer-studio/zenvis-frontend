...
基于 Vue 3 + TypeScript + Vite 构建的现代化前端可视化平台。

## 📋 项目简介

ZenVis Frontend 是一个专注于数据可视化和智能分析的前端应用，提供仪表盘、数据检索、策略管理、DIH（数据集成处理）等核心功能模块。
...
| `VITE_BASE_UPLOAD_URL` | 上传服务路径 |
| `VITE_BASE_UPLOAD` | 上传服务地址 |
